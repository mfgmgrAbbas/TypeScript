...
(async () => {
    ...
    const slectedOpt = await inquirer.prompt([
        {
            name: "Options",
    ...
    if (slectedOpt.Options === "cash withdrawals") {
        ...
        console.log("Your current Balance is: ", userData.amount);
        const fundTrns = await inquirer.prompt([
            {
                name: "fundTransfer",
        ...
        console.log("Your current Balance is: ", userData.amount);
        const utilityBill = await inquirer.prompt([
            {
                name: "billOptions",
        ...
        if (utilityBill.billOptions == "Electricity Bill") {
            ...
            const payElectBill = await inquirer.prompt([
                {
            ...
            const paySuiGasBill = await inquirer.prompt([
                {
                    name: "paySbill",
